...
City class: inherits from Base (imported from model_state), links to the
MySQL table cities, class attribute id that represents a column of an
auto-generated, unique integer, can't be null and is a primary key, class
attribute name that represents a column of a string of 128 characters
and can't be null, class attribute state_id that represents a column of an
